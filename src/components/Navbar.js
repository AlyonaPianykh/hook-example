  ...
  return (
    <Fragment>
      <nav className='z-depth-0'>
        <div className='nav-wrapper'>
          ...
          <ul className='right hide-on-med-and-down'>
            ...
            <li>
              <Link to='/booklist-fetch'>Best Sellers</Link>
            </li>
            <li>
              <Link to='/booklist-collection'>Fiction</Link>
            </li>
          </ul>
        </div>
      </nav>
      ...
      <ul id='slide-out' className='sidenav'>
        ...
        <li>
          <Link to='/booklist-fetch' className='waves-effect sidenav-close'>
            <i className='material-icons'>mail</i>Fetch Example
          </Link>
        </li>
      </ul>
    </Fragment>
